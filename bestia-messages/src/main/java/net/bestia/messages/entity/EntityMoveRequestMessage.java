 ...
 * {@link EntityMoveRequestMessage} is send by the server it takes precedence over the
 * old one.
 * </p>
 * 
 * @author Thomas Felix
...
public class EntityMoveRequestMessage extends EntityJsonMessage implements ComponentMessage {
	 ...
	 * @param walkspeed
	 */
	public EntityMoveRequestMessage(long eid, List<Point> path, Walkspeed walkspeed) {
		this(0, eid, path, walkspeed);
	}

	public EntityMoveRequestMessage(long accId, long eid, List<Point> path, Walkspeed walkspeed) {
		super(accId, eid);
