 ...
 * the payload field.
 */
public class EntityComponentEnvelopeEx extends EntityJsonMessage {
	 ...
	 */
	public EntityComponentEnvelopeEx(long accId, long entityId,
	...
	public JsonMessage createNewInstance(long accountId, int latency) {
		return new EntityComponentEnvelopeEx(accountId,
				getEntityId(),
				getComponentName(),
				getPayload(),
				latency);
