...
public class I18n {
	...
	private static I18nRepository i18NRepository = null;
	...
	public static void setDao(I18nRepository dao) {
		if (dao == null) {
	...
	public static String t(String lang, String key, Object... args) {
		...
		final net.bestia.model.i18n.I18n trans = I18n.i18NRepository.findOne(cat, keyClean, lang);
		if (trans == null) {
			final String errMsg = String.format("%s-%s", NO_TRANSLATION, key);
			LOG.warn(errMsg);
			return errMsg;
