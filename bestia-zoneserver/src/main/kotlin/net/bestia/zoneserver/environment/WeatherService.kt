...
class WeatherService {
  ...
  fun calculateWeatherInCell(x: Long, y: Long) {
    ...
    val hLayers = listOf(50f, 10f, 10f)
    ...
    val dEvap = listOf(hLayers[0] * tEvap[0], hLayers[1] * tEvap[1], 0f)

    // dEvap * hLayer und ergebnis dann auf layer1 adden, layer1 -> layer2
    ...
    // berechnen
    // temperatur gradient zu den nachbarn berechnen, wind weht von kalt nach warm
