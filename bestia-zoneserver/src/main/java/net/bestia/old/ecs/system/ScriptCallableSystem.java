 ...
 */
@Wire
public class ScriptCallableSystem extends DelayedIteratingSystem {
	
	private static final Logger LOG = LogManager.getLogger(ScriptCallableSystem.class);
	
	private ComponentMapper<ScriptCallable> callableMapper;
	private ComponentMapper<Delay> delayMapper;

	public ScriptCallableSystem() {
