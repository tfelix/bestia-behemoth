 ...
 *
 */
public class MapScriptTemplate {

	private final CollisionShape shape;
	private final String scriptName;
	private final int tickRate;

	public MapScriptTemplate(String scriptName, CollisionShape shape) {
		this.shape = shape;
		this.scriptName = scriptName;
		this.tickRate = -1;
	}

	public MapScriptTemplate(String scriptName, CollisionShape shape, int tickRate) {
		if(tickRate < 0) {
