...
/**
 * Uniquely identifies a {@link Component} sub-class. It assigns them an index
 * which is used internally for fast comparison and retrieval. See
 * {@link Family} and {@link Entity}. ComponentType is a package protected
 * class. You cannot instantiate a ComponentType. They can only be accessed via
 * {@link #getIndexFor(Class<? extends Component>)}. Each component class will
 * always return the same instance of ComponentType.
 * 
...
public final class ComponentType {
	 ...
	 * {@link ComponentType.getFor(Class<? extends Component>)}.
	 * 
	 * @param componentType
	 *            The {@link Component} class
