...
public class NpcBestiaEntityProxy2 extends BestiaEntityProxy {
	
	private static final Logger LOG = LogManager.getLogger(NpcBestiaEntityProxy2.class);
	...
	public NpcBestiaEntityProxy2(int entityID, Bestia bestia, World world) {
		super(entityID, null);
