 ...
 * to be persisted into the database. The {@link bestia.model.map.Map} class
 * is optimized for storage of the map parts inside the database. The
 * {@link bestia.model.map.Map} for access by the game and {@link MapChunk}
 * for transfer to the client system.
 * 
 * @see {@link bestia.model.map.Map} {@link MapChunk}.
 * @author Thomas Felix
 *
 */
