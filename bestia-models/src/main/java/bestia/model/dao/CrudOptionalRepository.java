...
/**
 * Similar to {@link CrudRepository} from Spring. It returns java new optional instead.
 * 
 * @author Thomas Felix
 *
 */
@NoRepositoryBean
interface CrudOptionalRepository<T, ID extends Serializable> extends Repository<T, ID> {
