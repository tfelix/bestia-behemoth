...
import net.bestia.zone.ai.core.MarketDomain.GOLD
import net.bestia.zone.ai.core.MarketDomain.INVENTORY
import net.bestia.zone.ai.core.MarketDomain.MARKET
import net.bestia.zone.ai.core.MarketDomain.POSITION
import net.bestia.zone.ai.core.MarketDomain.SATIATION
import net.bestia.zone.ai.core.MarketDomain.TIREDNESS
...
import net.bestia.zone.ai.core.goal.InverseLinearCurve
import net.bestia.zone.ai.core.goal.LinearCurve
...
class MarketSimulationE2ETest {
  ...
  fun `villager eats until the gold runs out, then planning fails`() {
    ...
    executor.execute(day1!!, agent, world)
    ...
    executor.execute(day2!!, agent, world)
    ...
    executor.execute(day3!!, agent, world)
    assertEquals(100, memory.get(SATIATION))
