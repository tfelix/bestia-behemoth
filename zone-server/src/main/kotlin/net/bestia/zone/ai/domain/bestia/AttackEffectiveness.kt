 ...
 * planning loop: [net.bestia.zone.ai.domain.bestia.action.AttackActionTemplate] only *reads*
 * [BestiaDomain.ATTACK_EFFECTIVENESS] to prefer cheaper (= remembered-effective) attacks over
 * unproven or confirmed-poor ones. Something outside this domain that actually resolves combat and knows
