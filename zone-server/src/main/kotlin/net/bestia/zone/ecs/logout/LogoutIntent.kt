 ...
 * roughly every [CountdownBar.SYNC_INTERVAL_SECONDS] to correct drift while the client interpolates
 * locally in between. It is [Removable]: cancelling a logout is simply removing this component, which
 * re-sends [LogoutIntentComponentSMSG] with `removed = true`, read by the client as "logout aborted".
 */
class LogoutIntent(
