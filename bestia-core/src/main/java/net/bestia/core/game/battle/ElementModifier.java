...
public final class ElementModifier {
	...
	static {
		...
		elementMap.put(new ElementKey(Element.NORMAL, Element.GHOST_3), 25);
		...
		elementMap.put(new ElementKey(Element.WATER, Element.FIRE_3), 150);
		elementMap.put(new ElementKey(Element.WATER, Element.WIND_3), 50);
		elementMap.put(new ElementKey(Element.WATER, Element.POISON_3), 100);
		elementMap.put(new ElementKey(Element.WATER, Element.HOLY_3), 75);
		elementMap.put(new ElementKey(Element.WATER, Element.SHADOW_3), 100);
		elementMap.put(new ElementKey(Element.WATER, Element.GHOST_3), 100);
		elementMap.put(new ElementKey(Element.WATER, Element.UNDEAD_3), 100);
		...
		elementMap.put(new ElementKey(Element.EARTH, Element.EARTH_3), 100);
		elementMap.put(new ElementKey(Element.EARTH, Element.FIRE_3), 50);
		elementMap.put(new ElementKey(Element.EARTH, Element.WIND_3), 150);
		elementMap.put(new ElementKey(Element.EARTH, Element.POISON_3), 100);
		elementMap.put(new ElementKey(Element.EARTH, Element.HOLY_3), 75);
		elementMap.put(new ElementKey(Element.EARTH, Element.SHADOW_3), 100);
		elementMap.put(new ElementKey(Element.EARTH, Element.GHOST_3), 100);
		elementMap.put(new ElementKey(Element.EARTH, Element.UNDEAD_3), 100);
		
		elementMap.put(new ElementKey(Element.FIRE, Element.NORMAL_3), 100);
		elementMap.put(new ElementKey(Element.FIRE, Element.WATER_3), 50);
		elementMap.put(new ElementKey(Element.FIRE, Element.EARTH_3), 150);
		...
		elementMap.put(new ElementKey(Element.FIRE, Element.HOLY_3), 75);
		elementMap.put(new ElementKey(Element.FIRE, Element.SHADOW_3), 100);
		elementMap.put(new ElementKey(Element.FIRE, Element.GHOST_3), 100);
		elementMap.put(new ElementKey(Element.FIRE, Element.UNDEAD_3), 125);
		
		elementMap.put(new ElementKey(Element.WIND, Element.NORMAL_3), 100);
		elementMap.put(new ElementKey(Element.WIND, Element.WATER_3), 175);
		elementMap.put(new ElementKey(Element.WIND, Element.EARTH_3), 50);
		...
		elementMap.put(new ElementKey(Element.WIND, Element.HOLY_3), 75);
		elementMap.put(new ElementKey(Element.WIND, Element.SHADOW_3), 100);
		...
		elementMap.put(new ElementKey(Element.POISON, Element.WATER_3), 100);
		elementMap.put(new ElementKey(Element.POISON, Element.EARTH_3), 125);
		elementMap.put(new ElementKey(Element.POISON, Element.FIRE_3), 125);
		elementMap.put(new ElementKey(Element.POISON, Element.WIND_3), 125);
		elementMap.put(new ElementKey(Element.POISON, Element.POISON_3), 0);
		elementMap.put(new ElementKey(Element.POISON, Element.HOLY_3), 75);
		elementMap.put(new ElementKey(Element.POISON, Element.SHADOW_3), 50);
		elementMap.put(new ElementKey(Element.POISON, Element.GHOST_3), 100);
		elementMap.put(new ElementKey(Element.POISON, Element.UNDEAD_3), -25);
		...
		elementMap.put(new ElementKey(Element.HOLY, Element.POISON_3), 100);
		elementMap.put(new ElementKey(Element.HOLY, Element.HOLY_3), 0);
		elementMap.put(new ElementKey(Element.HOLY, Element.SHADOW_3), 125);
		elementMap.put(new ElementKey(Element.HOLY, Element.GHOST_3), 100);
		elementMap.put(new ElementKey(Element.HOLY, Element.UNDEAD_3), 150);
		...
		elementMap.put(new ElementKey(Element.SHADOW, Element.POISON_3), 50);
		elementMap.put(new ElementKey(Element.SHADOW, Element.HOLY_3), 125);
		elementMap.put(new ElementKey(Element.SHADOW, Element.SHADOW_3), 0);
		elementMap.put(new ElementKey(Element.SHADOW, Element.GHOST_3), 100);
		elementMap.put(new ElementKey(Element.SHADOW, Element.UNDEAD_3), -25);
		
		elementMap.put(new ElementKey(Element.GHOST, Element.NORMAL_3), 25);
		elementMap.put(new ElementKey(Element.GHOST, Element.WATER_3), 100);
		elementMap.put(new ElementKey(Element.GHOST, Element.EARTH_3), 100);
		elementMap.put(new ElementKey(Element.GHOST, Element.FIRE_3), 100);
		elementMap.put(new ElementKey(Element.GHOST, Element.WIND_3), 100);
		elementMap.put(new ElementKey(Element.GHOST, Element.POISON_3), 100);
		elementMap.put(new ElementKey(Element.GHOST, Element.HOLY_3), 75);
		elementMap.put(new ElementKey(Element.GHOST, Element.SHADOW_3), 75);
		elementMap.put(new ElementKey(Element.GHOST, Element.GHOST_3), 125);
		elementMap.put(new ElementKey(Element.GHOST, Element.UNDEAD_3), 100);
		
		elementMap.put(new ElementKey(Element.UNDEAD, Element.NORMAL_3), 100);
		elementMap.put(new ElementKey(Element.UNDEAD, Element.WATER_3), 100);
		elementMap.put(new ElementKey(Element.UNDEAD, Element.EARTH_3), 100);
		elementMap.put(new ElementKey(Element.UNDEAD, Element.FIRE_3), 100);
		elementMap.put(new ElementKey(Element.UNDEAD, Element.WIND_3), 100);
		elementMap.put(new ElementKey(Element.UNDEAD, Element.POISON_3), 50);
		elementMap.put(new ElementKey(Element.UNDEAD, Element.HOLY_3), 100);
		...
		elementMap.put(new ElementKey(Element.NORMAL, Element.GHOST_4), 25);
		...
		elementMap.put(new ElementKey(Element.WATER, Element.WATER_4), 25);
		elementMap.put(new ElementKey(Element.WATER, Element.EARTH_4), 100);
		elementMap.put(new ElementKey(Element.WATER, Element.FIRE_4), 150);
		elementMap.put(new ElementKey(Element.WATER, Element.WIND_4), 50);
		elementMap.put(new ElementKey(Element.WATER, Element.POISON_4), 100);
		elementMap.put(new ElementKey(Element.WATER, Element.HOLY_4), 75);
		elementMap.put(new ElementKey(Element.WATER, Element.SHADOW_4), 100);
		elementMap.put(new ElementKey(Element.WATER, Element.GHOST_4), 100);
		elementMap.put(new ElementKey(Element.WATER, Element.UNDEAD_4), 100);
		...
		elementMap.put(new ElementKey(Element.EARTH, Element.EARTH_4), 100);
		elementMap.put(new ElementKey(Element.EARTH, Element.FIRE_4), 50);
		elementMap.put(new ElementKey(Element.EARTH, Element.WIND_4), 150);
		elementMap.put(new ElementKey(Element.EARTH, Element.POISON_4), 100);
		elementMap.put(new ElementKey(Element.EARTH, Element.HOLY_4), 75);
		elementMap.put(new ElementKey(Element.EARTH, Element.SHADOW_4), 100);
		elementMap.put(new ElementKey(Element.EARTH, Element.GHOST_4), 100);
		elementMap.put(new ElementKey(Element.EARTH, Element.UNDEAD_4), 100);
		
		elementMap.put(new ElementKey(Element.FIRE, Element.NORMAL_4), 100);
		elementMap.put(new ElementKey(Element.FIRE, Element.WATER_4), 50);
		elementMap.put(new ElementKey(Element.FIRE, Element.EARTH_4), 150);
		elementMap.put(new ElementKey(Element.FIRE, Element.FIRE_4), 25);
		elementMap.put(new ElementKey(Element.FIRE, Element.WIND_4), 100);
		elementMap.put(new ElementKey(Element.FIRE, Element.POISON_4), 100);
		elementMap.put(new ElementKey(Element.FIRE, Element.HOLY_4), 75);
		elementMap.put(new ElementKey(Element.FIRE, Element.SHADOW_4), 100);
		elementMap.put(new ElementKey(Element.FIRE, Element.GHOST_4), 100);
		elementMap.put(new ElementKey(Element.FIRE, Element.UNDEAD_4), 125);
		
		elementMap.put(new ElementKey(Element.WIND, Element.NORMAL_4), 100);
		elementMap.put(new ElementKey(Element.WIND, Element.WATER_4), 175);
		elementMap.put(new ElementKey(Element.WIND, Element.EARTH_4), 50);
		elementMap.put(new ElementKey(Element.WIND, Element.FIRE_4), 100);
		elementMap.put(new ElementKey(Element.WIND, Element.WIND_4), 25);
		elementMap.put(new ElementKey(Element.WIND, Element.POISON_4), 100);
		elementMap.put(new ElementKey(Element.WIND, Element.HOLY_4), 75);
		elementMap.put(new ElementKey(Element.WIND, Element.SHADOW_4), 100);
		...
		elementMap.put(new ElementKey(Element.POISON, Element.WATER_4), 100);
		elementMap.put(new ElementKey(Element.POISON, Element.EARTH_4), 125);
		elementMap.put(new ElementKey(Element.POISON, Element.FIRE_4), 125);
		elementMap.put(new ElementKey(Element.POISON, Element.WIND_4), 125);
		elementMap.put(new ElementKey(Element.POISON, Element.POISON_4), 0);
		elementMap.put(new ElementKey(Element.POISON, Element.HOLY_4), 75);
		elementMap.put(new ElementKey(Element.POISON, Element.SHADOW_4), 50);
		elementMap.put(new ElementKey(Element.POISON, Element.GHOST_4), 100);
		elementMap.put(new ElementKey(Element.POISON, Element.UNDEAD_4), -25);
		
		elementMap.put(new ElementKey(Element.HOLY, Element.HOLY_4), 100);
		elementMap.put(new ElementKey(Element.HOLY, Element.WATER_4), 100);
		elementMap.put(new ElementKey(Element.HOLY, Element.EARTH_4), 100);
		elementMap.put(new ElementKey(Element.HOLY, Element.FIRE_4), 100);
		elementMap.put(new ElementKey(Element.HOLY, Element.WIND_4), 100);
		elementMap.put(new ElementKey(Element.HOLY, Element.POISON_4), 100);
		elementMap.put(new ElementKey(Element.HOLY, Element.HOLY_4), 0);
		elementMap.put(new ElementKey(Element.HOLY, Element.SHADOW_4), 125);
		elementMap.put(new ElementKey(Element.HOLY, Element.GHOST_4), 100);
		elementMap.put(new ElementKey(Element.HOLY, Element.UNDEAD_4), 150);
		
		elementMap.put(new ElementKey(Element.SHADOW, Element.NORMAL_4), 100);
		elementMap.put(new ElementKey(Element.SHADOW, Element.WATER_4), 100);
		elementMap.put(new ElementKey(Element.SHADOW, Element.EARTH_4), 100);
		elementMap.put(new ElementKey(Element.SHADOW, Element.FIRE_4), 100);
		elementMap.put(new ElementKey(Element.SHADOW, Element.WIND_4), 100);
		elementMap.put(new ElementKey(Element.SHADOW, Element.POISON_4), 50);
		elementMap.put(new ElementKey(Element.SHADOW, Element.HOLY_4), 125);
		elementMap.put(new ElementKey(Element.SHADOW, Element.SHADOW_4), 0);
		elementMap.put(new ElementKey(Element.SHADOW, Element.GHOST_4), 100);
		elementMap.put(new ElementKey(Element.SHADOW, Element.UNDEAD_4), -25);
		
		elementMap.put(new ElementKey(Element.GHOST, Element.NORMAL_4), 25);
		elementMap.put(new ElementKey(Element.GHOST, Element.WATER_4), 100);
		elementMap.put(new ElementKey(Element.GHOST, Element.EARTH_4), 100);
		elementMap.put(new ElementKey(Element.GHOST, Element.FIRE_4), 100);
		elementMap.put(new ElementKey(Element.GHOST, Element.WIND_4), 100);
		elementMap.put(new ElementKey(Element.GHOST, Element.POISON_4), 100);
		elementMap.put(new ElementKey(Element.GHOST, Element.HOLY_4), 75);
		elementMap.put(new ElementKey(Element.GHOST, Element.SHADOW_4), 75);
		elementMap.put(new ElementKey(Element.GHOST, Element.GHOST_4), 125);
		elementMap.put(new ElementKey(Element.GHOST, Element.UNDEAD_4), 100);
		
		elementMap.put(new ElementKey(Element.UNDEAD, Element.NORMAL_4), 100);
		elementMap.put(new ElementKey(Element.UNDEAD, Element.WATER_4), 100);
		elementMap.put(new ElementKey(Element.UNDEAD, Element.EARTH_4), 100);
		elementMap.put(new ElementKey(Element.UNDEAD, Element.FIRE_4), 100);
		elementMap.put(new ElementKey(Element.UNDEAD, Element.WIND_4), 100);
		elementMap.put(new ElementKey(Element.UNDEAD, Element.POISON_4), 50);
		elementMap.put(new ElementKey(Element.UNDEAD, Element.HOLY_4), 100);
