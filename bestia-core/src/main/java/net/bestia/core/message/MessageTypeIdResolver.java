...
/**
 * Custom TypeId Resolver for message objects. Upon start it looks for all messages which
 * inherit from Message and determine their id. It stores it and uses this serialize the
 * messages.
 * 
