...
(function(Bestia, $) {
	...
	/**
	 * Main message module. Responsible for sending messages to the server and
	 * to receive them and rebroadcast them into the client.
	 * 
	 * @module Bestia.Connection
	 */
	...
	Bestia.Connection.prototype.init = function() {
		...
		this.Connection.socket = $.atmosphere.subscribe(request);
	};
