...
(function(Bestia, $, ko) {
	...
	/**
	 * In this module all methods, views for the display and the user
	 * interaction with the inventory will be defined.
	 * 
	 * @class Bestia.Inventory.ItemViewModel
	 * @constructor
	 * @param {Bestia.Net}
	 *            net - Handle to a Net object which will provide correct
	 *            resource URLs to do on demand ajax loading.
	 * @param {Object}
	 *            msg - Optional, message used to initialize the view model.
	 */
